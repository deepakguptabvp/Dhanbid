  ...
  return (
    <div className=" flex flex-col items-center justify-center dark:bg-white dark:text-black">
      <div className="space-y-6 mb-6 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800 drop-shadow-lg pt-14">
          Welcome to Dhanbid
        </h1>

        <h1 className="text-xl md:text-2xl font-medium text-center justify-center text-gray-600">
          Select your role to continue
        </h1>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 w-full max-w-4xl p-6">
        {/* Buyer Dashboard */}
