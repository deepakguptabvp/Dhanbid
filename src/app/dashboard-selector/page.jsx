...
import { FaUserTie, FaTruckMoving } from "react-icons/fa"; 

const DashboardSelector = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-300 via-white to-purple-300 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 w-full max-w-4xl">
        ...
        <Link href="/buyer-dashboard" passHref>
          <div
            className="cursor-pointer backdrop-blur-md bg-white/30 border border-blue-400/40
          ...
          >
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-gray-700 mt-2 text-sm">
                View tenders, submit tenders, and manage your purchase needs.
              </p>
            </div>
          </div>
        </Link>
        ...
        <Link href="/supplier-dashboard" passHref>
          <div className="cursor-pointer backdrop-blur-md bg-white/30 border border-green-400/40 hover:border-green-600/60 hover:shadow-green-500/30 shadow-lg hover:scale-[1.03] transition-all duration-300 ease-in-out rounded-2xl p-8 text-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-gray-700 mt-2 text-sm">
                Manage your submissions, respond to tenders, and track bid
                status.
              </p>
            </div>
          </div>
