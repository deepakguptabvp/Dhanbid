      ...
      <div className="flex items-center justify-between md:justify-normal gap-4">
        ...
        <div className="hidden md:flex items-center gap-4">
          {/* <Link href="/buyer-dashboard">
            <button className="relative right-30 hover:underline">
              Post Requirement
            </button>
          </Link> */}
        ...
        <div className="md:hidden mt-4 space-y-4">
          <div className="relative">
            <input
              type="text"
              placeholder="Search requirement (ACs, Fabric Material, Chair's,...)"
              className="pl-4 pr-10 py-2 w-full rounded-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-white"
            />
            <FaSearch className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500" />
          </div>
