...
export default function TenderWithBidsCard({ id, setActiveSection,setSelectedChat  }) {
        ...
        <div className=" mx-auto p-6 h-full bg-white rounded-2xl shadow-md border border-gray-200 ">
            ...
            <div className="mb-4">
                <div className="flex items-center pb-4 justify-between">
                    <button onClick={() => setActiveSection('my-tenders')} className="p-2 rounded-lg cursor-pointer flex gap-1 items-center justify-center text-white bg-black"> <FaChevronLeft /> Back</button>
                        ...
                        <div className="space-y-4">
                            {tender?.bids.map((bid, index) => (
                                ...
                                >
                                    ...
                                    <button onClick={() => handleChatNow(bid)} className="mt-3 rounded-lg bg-[#0200b9] p-3 text-white">Chat Now</button>
