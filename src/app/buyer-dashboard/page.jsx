...
const page = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen overflow-hidden dark:text-black w-full bg-white">
      ...
      <aside
        className={`
          fixed top-0 inset-y-0 left-0 z-50 md:z-20  w-64 bg-white shadow-md p-4 transform transition-transform duration-300 ease-in-out
        ...
        <nav className="space-y-2 mt-4">
          ...
          >
            <div className="inline-flex items-center justify-center">
              <LuClipboardList size={20} className="m-1.5" />
              <span className="m-1.5">My Orders</span>
            </div>
          </button>
          ...
          >
            <div className="inline-flex items-center justify-center">
              <FaPlus size={20} className="m-1.5" />
              <span className="m-1.5">Create order</span>
            </div>
          </button>
          ...
          >
            <div className="inline-flex items-center justify-center">
              <FaUserTie size={20} className="m-1.5" />
              <span className="m-1.5">My Profile</span>
            </div>
          </button>
        </nav>
      </aside>
